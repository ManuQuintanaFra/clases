...
export class Home {
  ...
  // Delega al servicio que hace UPDATE en Supabase
  // El Realtime se encarga de actualizar el signal en todos los clientes
  async onLibroReservado(libroId: string): Promise<void> {
    await this.bookService.reservarLibro(libroId, 'Usuario');
  }
